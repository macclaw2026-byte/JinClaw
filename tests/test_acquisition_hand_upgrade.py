...
class AcquisitionHandUpgradeTest(unittest.TestCase):
    ...
    def test_external_task_builds_unified_acquisition_hand(self):
        ...
        self.assertTrue(hand['delivery_requirements']['required_fields_by_site'])
        self.assertIn('amazon', hand['delivery_requirements']['required_fields_by_site'])
        self.assertIn('price', hand['delivery_requirements']['goal_field_signals'])
        ...
        self.assertIn('source_trust_tier', hand['result_consensus']['required_provenance_fields'])
