...
class AcquisitionExecutionSummaryTest(unittest.TestCase):
    ...
    def test_execution_summary_reports_cross_route_validation(self):
        ...
        self.assertEqual(summary['overall_summary']['answer_synthesis']['status'], 'guarded')
        self.assertEqual(summary['overall_summary']['answer_synthesis']['response_mode'], 'guarded_answer')
        self.assertTrue(summary['site_synthesized_outputs'][0]['answer_synthesis']['answerable'])
        self.assertEqual(summary['site_synthesized_outputs'][0]['answer_synthesis']['required_fields'][0]['field_name'], 'title')
    ...
    def test_execution_summary_prefers_higher_trust_source_for_required_field_conflict(self):
        ...
        self.assertGreater(price_provenance['selection_weight'], 0.0)
        self.assertEqual(price_provenance['selection_factors']['field_priority'], 'required')
        ...
        self.assertEqual(summary['overall_summary']['answer_synthesis']['status'], 'ready')
        self.assertEqual(summary['overall_summary']['answer_synthesis']['response_mode'], 'auto_answer')
    ...
    def test_execution_summary_prefers_fresher_evidence_when_trust_rank_is_tied(self):
        ...
        self.assertEqual(price_provenance['selection_factors']['freshness_rank'], 3)
        self.assertEqual(summary['overall_summary']['governed_release_status'], 'auto_release_allowed')
    ...
    def test_execution_summary_marks_low_trust_browser_release_as_guarded(self):
        ...
        self.assertEqual(summary['overall_summary']['answer_synthesis']['status'], 'blocked')
        self.assertEqual(summary['overall_summary']['answer_synthesis']['response_mode'], 'pause_and_recapture')
    ...
    def test_execution_summary_requires_user_confirmation_for_strict_guarded_release(self):
        ...
        self.assertEqual(summary['overall_summary']['answer_synthesis']['response_mode'], 'confirm_then_guarded_answer')
        self.assertFalse(summary['site_synthesized_outputs'][0]['governed_release_ready'])
    ...
    def test_verifier_accepts_complete_acquisition_summary(self):
        ...
        self.assertEqual(snapshot['acquisition_hand']['answer_synthesis']['response_mode'], 'guarded_answer')
        self.assertEqual(snapshot['reply_contract']['acquisition_response']['response_mode'], 'guarded_answer')
        self.assertTrue(snapshot['reply_contract']['acquisition_response']['preview_lines'])
        self.assertIn('Current data answer mode is guarded_answer.', snapshot['authoritative_summary'])
