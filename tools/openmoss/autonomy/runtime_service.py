...
def _reopen_incomplete_terminal_crawler_task(task_id: str) -> dict | None:
    ...
    acquisition_result = run_verifier({"type": "acquisition_summary_complete", "task_id": task_id})
    ...
    elif not acquisition_result.get("ok") and acquisition_result.get("status") != "not_required":
        target_stage = "execute"
        reason = "missing_acquisition_summary"
