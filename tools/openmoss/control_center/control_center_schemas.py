...
def build_execution_handoff_schema(
    *,
    ...
    return {
        ...
        "execution_session_strategy": str(execution_session_strategy).strip(),
        "execution_session_strategy_reason": str(execution_session_strategy_reason).strip(),
...
def build_goal_continuation_schema(
    *,
    ...
    periodic_delivery: bool = False,
    scheduled_followthrough_required: bool = False,
    ...
    return {
        ...
        "periodic_delivery": bool(periodic_delivery),
        "scheduled_followthrough_required": bool(scheduled_followthrough_required),
        "delivery_cadence": str(delivery_cadence).strip(),
...
def build_capability_gap_schema(
    *,
    ...
    tool_evolution_plan: Dict[str, Any] | None = None,
    rationale: List[str] | None = None,
    contract_source: str = "",
    checked_at: str = "",
) -> Dict[str, Any]:
    ...
    return {
        ...
        "tool_evolution_plan": dict(tool_evolution_plan or {}),
        "rationale": list(rationale or []),
        "contract_source": str(contract_source).strip(),
        "checked_at": str(checked_at).strip(),
    }
