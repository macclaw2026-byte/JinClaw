...
def build_control_plane(*, stale_after_seconds: int = 300, escalation_after_seconds: int = 900) -> Dict[str, Any]:
    ...
    snapshot = {
        ...
        "summary": {
            ...
            "crawler_effective_width_score": crawler_capability_profile.get("summary", {}).get("effective_width_score", 0),
            "crawler_objective_completion_status": crawler_capability_profile.get("summary", {}).get("completion_status", "unknown"),
            "crawler_objective_completion_score": crawler_capability_profile.get("summary", {}).get("completion_score", 0),
            "crawler_objective_goal_reached": crawler_capability_profile.get("summary", {}).get("goal_reached", False),
            "crawler_completion_blocker_total": crawler_capability_profile.get("summary", {}).get("completion_blocker_total", 0),
